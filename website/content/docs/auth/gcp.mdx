...
[![Vault Google Cloud IAM Login Workflow](https://vaultproject.io/img/vault-gcp-iam-auth-workflow.svg)](https://vaultproject.io/img/vault-gcp-iam-auth-workflow.svg)
...
[![Vault Google Cloud GCE Login Workflow](https://vaultproject.io/img/vault-gcp-gce-auth-workflow.svg)](https://vaultproject.io/img/vault-gcp-gce-auth-workflow.svg)

...
[![Vault Auth Workflow](https://vaultproject.io/img/vault-policy-workflow.svg)](https://vaultproject.io/img/vault-policy-workflow.svg)
...
[![Vault Auth Workflow](https://vaultproject.io/img/vault-auth-workflow.svg)](https://vaultproject.io/img/vault-auth-workflow.svg)

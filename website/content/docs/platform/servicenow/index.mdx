...
[![Architecture Overview](https://vaultproject.io/img/servicenow-vault-credential-resolver-diagram.png)](https://vaultproject.io/img/servicenow-vault-credential-resolver-diagram.png)
